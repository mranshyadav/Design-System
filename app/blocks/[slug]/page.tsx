...
export default function Example() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden bg-white dark:bg-gray-900 shadow-card">
      ...
      {/* Tab content */}
      {activeTab === 'preview' ? (
        <div className="min-h-[500px] bg-[length:20px_20px] bg-[image:linear-gradient(to_right,rgb(0,0,0,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgb(0,0,0,0.03)_1px,transparent_1px)] dark:bg-[image:linear-gradient(to_right,rgb(255,255,255,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgb(255,255,255,0.03)_1px,transparent_1px)] flex items-center justify-center p-8">
          <div className="w-full max-w-4xl bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-xl overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
              <div className="flex gap-1.5">
                {[1,2,3].map(i => <div key={i} className="w-3 h-3 rounded-full bg-gray-200 dark:bg-gray-700" />)}
              </div>
              <div className="flex-1 mx-4 h-5 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center px-3">
            ...
            <div className="p-8">
              <div className="flex items-center justify-center py-12 text-center">
                <div>
                  <div className="w-20 h-20 rounded-3xl bg-accent-50 dark:bg-accent-500/10 flex items-center justify-center mx-auto mb-4">
                    <Eye size={32} className="text-accent-500" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">{block.title}</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xs">{block.description}</p>
                </div>
              </div>
            </div>
          </div>
