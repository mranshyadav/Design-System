...
export function CheckMedNavbar() {
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
        {/* Logo */}
        <a href="/checkmed" className="flex items-center gap-2.5 font-extrabold text-lg text-slate-900 dark:text-white">
          <span className="w-8 h-8 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center shadow-md shadow-teal-500/30">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="#get-started"
            className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 text-white text-sm font-semibold hover:from-teal-600 hover:to-cyan-600 transition-all shadow-md shadow-teal-500/25"
          >
            Get started
          </a>

          <button
            className="md:hidden w-8 h-8 flex items-center justify-center text-slate-600 dark:text-slate-300"
